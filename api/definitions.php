...
// --- DEFINIÇÕES
define("IG_SELECT_DELAY", "-3 hour");
define("IG_SELECT_DELAY_PREMIUM", "-1 hour");
define("IG_STATS_RANGE", "-1 month");

define("API_URL", "api");
if(in_array($_SERVER['HTTP_HOST'], array('localhost', "::1"))) {
    define("LOCAL", true);
    define("BASE_URL", "http://localhost/yadah-website/percepter");
    ...
    define("LOCAL", false);
    define("BASE_URL", "http://percepter.appspot.com");
...
define("DEFAULT_LOGGED", BASE_URL . "/vote.php");
...
define("LOGGED_IN", isset($_SESSION["ig_id"]));
